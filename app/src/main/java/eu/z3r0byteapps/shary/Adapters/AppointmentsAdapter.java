...
public class AppointmentsAdapter extends ArrayAdapter<Appointment> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView period = rowView.findViewById(R.id.text_list_period);
        TextView lesson = rowView.findViewById(R.id.text_lesson);
        TextView classroom = rowView.findViewById(R.id.text_classroom);
        TextView time = rowView.findViewById(R.id.text_time);
        ImageView homework = rowView.findViewById(R.id.image_homework);
        ...
        time.setText(DateUtils.formatDate(DateUtils.addHours(appointments[position].startDate, 0), "HH:mm") + " - "
                + DateUtils.formatDate(DateUtils.addHours(appointments[position].endDate, 0), "HH:mm"));
