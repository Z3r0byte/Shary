...
import eu.z3r0byteapps.shary.MagisterLibrary.adapter.type.RowTypeAdapter;
import eu.z3r0byteapps.shary.MagisterLibrary.container.Grade;
import eu.z3r0byteapps.shary.MagisterLibrary.container.type.RowType;
...
public class GradeAdapter extends TypeAdapter<Grade[]> {
    ...
    @Override
    public void write(JsonWriter out, Grade[] value) {
