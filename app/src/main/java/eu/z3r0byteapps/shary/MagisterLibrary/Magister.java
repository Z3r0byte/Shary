...
package eu.z3r0byteapps.shary.MagisterLibrary;
...
import eu.z3r0byteapps.shary.MagisterLibrary.adapter.ProfileAdapter;
import eu.z3r0byteapps.shary.MagisterLibrary.adapter.StudyAdapter;
import eu.z3r0byteapps.shary.MagisterLibrary.adapter.SubjectAdapter;
...
import eu.z3r0byteapps.shary.MagisterLibrary.container.Session;
...
import eu.z3r0byteapps.shary.MagisterLibrary.container.Version;
import eu.z3r0byteapps.shary.MagisterLibrary.exeption.PrivilegeException;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.AppointmentHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.ContactHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.ELOHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.GradeHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.IHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.MessageHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.handler.PresenceHandler;
import eu.z3r0byteapps.shary.MagisterLibrary.util.AndroidUtil;
...
import eu.z3r0byteapps.shary.MagisterLibrary.util.android.ImageContainer;
...
public class Magister {
     ...
     */
    public static Magister login(School school, String username, String password) throws IOException, InvalidParameterException, NullPointerException, JsonSyntaxException {
