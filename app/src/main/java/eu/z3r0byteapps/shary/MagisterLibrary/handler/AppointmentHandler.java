...
import eu.z3r0byteapps.shary.MagisterLibrary.container.PersonalAppointment;
...
public class AppointmentHandler implements IHandler {
    ...
    public Boolean finishAppointment(Appointment appointment) throws IOException, JSONException {
        ...
        return result.contains("{\"Uri\":\"/api/personen/" + magister.profile.id + "/afspraken/" + appointment.id + "\"}");
    }
